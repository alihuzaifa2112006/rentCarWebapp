...
export default function CarBox({
    ...
    // Determine type from description or default to "Car"
        ...
        <div className="bg-white p-4 rounded-[20px] shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group w-full flex flex-col justify-between h-full">
            <div>
                ...
                <div className="flex justify-between items-start mb-3">
                    ...
                    <button className="text-gray-300 hover:text-red-500 transition-colors bg-transparent border-none cursor-pointer p-1 shrink-0">
            ...
            <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-50">
                ...
                <button className="bg-[#4186E4] hover:bg-[#3572c6] text-white px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all duration-300">
                    More Info
                </button>
            </div>
        </div>
